...
const LinkButton: React.FC<LinkButtonProps> = ({ children, link }) => {
  return (
    <a href={link} className='h-auto font-semibold flex flex-row items-center flex-start text-xs sm:text-sm w-auto hover:scale-105 hover:font-extrabold'  target="_blank">
